...
\author{Christian Trachsel\\Functional Genomics Center Zurich
  \And 
  Tobias Kockmann\\Functional Genomics Center Zurich
  \And
  Christian Panse\\Functional Genomics Center Zurich}
