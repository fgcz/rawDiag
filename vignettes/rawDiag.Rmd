...
package: rawDiag
abstract: |
  Optimizing liquid chromatography coupled to mass spectrometry (LC–MS) methods    presents a significant challenge. The 'rawDiag' package [@Trachsel2018],
...
```{r fetchFromExperimentHub, echo=FALSE, eval=FALSE}
