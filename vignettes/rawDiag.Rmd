...
(rawfile <- paste0(EH3222, ".raw"))
if (!file.exists(rawfile)){
  file.copy(EH3222, rawfile)
}
```
...
The package provides an simple interactive `r BiocStyle::Biocpkg('shiny')`-based
