...
The authors would like to thank Jim Shofstahl for his great support regarding the new Thermo Fisher RawFileReader library. Additionally, we would like to thank the two reviewers for their time to read our manuscript and their constructive and valuable input towards it. Further thank goes to Jay Tracy and our colleagues at the FGCZ for proofreading our manuscript. Last we would like to thank Lilly for her support with the graphical design of the package sticker. 
\end{acknowledgement}
